...
const { parseRange } = require('./versions');
...
// 其中六条登记带好了区间设定，四种写法各至少一条，在范围内与超出范围都能直接看到
function seedData() {
  return {
    projects: [
    ...
    deps: [
      { id: 'dep-2001', projectId: 'proj-1001', name: 'spring-boot', version: '2.7.18', license: 'Apache-2.0', owner: '陈晓', status: '在用', note: '基础框架', range: { kind: 'between', min: '2.7.0', minInclusive: true, max: '3.0.0', maxInclusive: false }, createdAt: '2026-08-28T03:00:00.000Z', updatedAt: '2026-09-15T06:10:00.000Z' },
      ...
      { id: 'dep-2003', projectId: 'proj-1001', name: 'redis-client', version: '3.1.0', license: 'MIT', owner: '', status: '待升', note: '等缓存改造完成后一起升', range: { kind: 'min', min: '4.0.0' }, createdAt: '2026-08-29T01:20:00.000Z', updatedAt: '2026-08-20T02:30:00.000Z' },
      ...
      { id: 'dep-2006', projectId: 'proj-1002', name: 'spring-boot', version: '2.6.15', license: 'Apache-2.0', owner: '李文', status: '在用', note: '基础框架，比订单服务低一档', range: { kind: 'between', min: '2.7.0', minInclusive: true, max: '3.0.0', maxInclusive: false }, createdAt: '2026-08-28T03:30:00.000Z', updatedAt: '2026-09-14T05:05:00.000Z' },
      ...
      { id: 'dep-2011', projectId: 'proj-1003', name: 'react', version: '18.2.0', license: 'MIT', owner: '王凯', status: '在用', note: '页面框架', range: { kind: 'major', major: 18 }, createdAt: '2026-08-28T04:00:00.000Z', updatedAt: '2026-09-16T02:00:00.000Z' },
      { id: 'dep-2012', projectId: 'proj-1003', name: 'axios', version: '1.6.2', license: 'MIT', owner: '王凯', status: '在用', note: '请求封装', range: { kind: 'min', min: '1.6.0' }, createdAt: '2026-08-28T04:02:00.000Z', updatedAt: '2026-09-16T02:02:00.000Z' },
      ...
      { id: 'dep-2014', projectId: 'proj-1003', name: 'moment', version: '2.29.4', license: 'MIT', owner: '王凯', status: '已弃用', note: '体积太大，计划整体换成 dayjs', range: { kind: 'max', max: '2.29.4' }, createdAt: '2026-08-29T08:05:00.000Z', updatedAt: '2026-09-10T01:00:00.000Z' },
...
// 把单条依赖登记整理成固定结构，状态不认识的一律按在用处理，区间设定不合法的一律按未设定处理
